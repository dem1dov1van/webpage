<template>
  <div class="w-full flex min-h-[80vh] items-center flex-wrap justify-center gap-10">
    <div class="grid gap-4 w-70">
      ...
      <div>
        ...
        <p class="text-center text-black text-base font-normal leading-relaxed pb-4">Участвуйте в розыгрыше мебели <br />и тут обязательно что-то появится </p>
        <div class="flex gap-3">
          <nuxt-link
              to="/store/rules/"
              class="w-full px-3 py-2 rounded-full border border-gray-300 text-gray-900 text-xs font-semibold leading-4 text-center min-w-max"
          >
            Читать правила
          </nuxt-link>
          <nuxt-link
