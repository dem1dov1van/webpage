    ...
    <div class="flex max-w-3xl flex-col py-10 md:py-12 lg:py-16">
      ...
      <div class="mb-6 flex flex-col items-start gap-y-3">
        <p class="text-sm sm:text-base">
          Выбирайте понравившийся товар и&nbsp;добавляйте в&nbsp;корзину. Количество товара неограниченно. Через 10&nbsp;рабочих дней после запуска распродажи мы&nbsp;проведем розыгрыш с&nbsp;помощью рандомайзера. Если ваша фамилия выпала, то&nbsp;у&nbsp;вас будет возможность выкупить свой товар.
        </p>
      </div>
      <div class="mb-6 flex flex-col items-start gap-y-3">
        <p class="text-sm sm:text-base">
